...
class Jobs extends Component {
  ...
  changeemplayement = value => {
    this.setState({activetypeofemplayement: value}, this.getProducts)
  }
  ...
  showjobsfailure = () => {
    return (
      <li>
        ...
        <button onClick={this.getProducts}>Retry</button>
      </li>
    )
  }
  ...
  renderjobitems = () => {
    ...
    switch (apistatsgorjobs) {
      ...
      case apiStatusConstants.inProgress:
        return this.renderLoadingViewfrojobs()
      default:
        return null
    }
  }
  ...
  changesalary = salaryrange => {
    this.setState({salaryrange}, this.getProducts)
  }
